...
[![GitHub Issues](https://img.shields.io/github/issues/glenluersman/taskinator.svg)](https://github.com/glenluersman/taskinator/issues)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/glenluersman/taskinator.svg)](https://github.com/glenluersman/taskinator/pulls)
...
Taskinator is a class module for introducing the DOM.
...
To use Taskinator simply enter a task name, pick a type, and click the add task button. Tasks can be moved from column to column with the dropdown menu. Tasks may also be edited and deleted with the respective buttons.
...
<img style="margin: 0 0 15px 0" src="./assets/images/taskinator.PNG" ></a>

<img style="margin: 0 0 15px 0" src="./assets/images/taskinator2.PNG" ></a>
